...
#    Updated: 2023/02/12 18:00:44 by albaud           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES	= args/args.c args/args_utils.c bonus/levels.c bonus/wildcards.c builtins/builtins.c\
			...
			list/vars_list.c parser/parser.c parser/parser_handler.c signals/signals.c vars/vars.c vars/vars2.c global/debug.c\
			bonus/priorities.c
OBJS 	= ${FILES:.c=.o}
INCL	= ./
LIB		= koflibc/libft.a
